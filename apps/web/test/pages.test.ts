...
describe('research figures', () => {
  ...
  const jev = model({ playerId: 'hex', model: 'jev-1.13.0', kind: 'jev', label: 'Jev (jev-1.13.0)', focus: true, latencyP50Ms: 200, costPerDecisionUsd: 0.00005, fallbackRate: 0, offTruthPts: 6, biasPts: -1, foldRight: { n: 30, rate: 0.9 }, callRight: { n: 10, rate: 0.8 }, bb100: { mean: 5, low: -25, high: 35 }, vsFocus: null, brierA: 0.2, eceC: 0.02 })
